  ...
  return (
    <ScreenContainer edges={["top", "left", "right", "bottom"]} containerClassName="bg-background" className="flex-1">
      <ScrollView contentContainerStyle={styles.loginScroll} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.loginTrust}><MaterialIcons name="verified-user" size={16} color="#18B889" /><Text style={styles.loginTrustText}>{language === "ar" ? "بياناتك محفوظة، وطلباتك عند أمينة سفرة" : "Your data stays protected and your orders stay cared for"}</Text></View>
      </ScrollView>
    </ScreenContainer>
  );
}
...
const styles = StyleSheet.create({
  ...
  loginError: { color: "#C44560", fontSize: 10, fontWeight: "800", lineHeight: 15 },
  ...
  loginTrustText: { color: "#18B889", fontSize: 10, fontWeight: "800", textAlign: "center", flex: 1 },
  ...
  driverHero: { borderRadius: 23, padding: 18, backgroundColor: "#E5FCFF", borderWidth: 1, borderColor: "#D9F99D", flexDirection: "row", alignItems: "center", justifyContent: "space-between" },
  ...
  driverOrderTagText: { color: "#18B889", fontSize: 10, fontWeight: "900" },
  ...
  routeMarkerPickup: { backgroundColor: "#18B889" },
  ...
  capacityMatchText: { flex: 1, color: "#18B889", fontSize: 10, fontWeight: "900" },
  capacityMatchTextWarn: { color: "#C44560" },
  ...
  driverDoneText: { color: "#18B889", fontSize: 11, fontWeight: "900" },
  ...
  mapHeaderBadgeText: { color: "#18B889", fontSize: 10, fontWeight: "900" },
  ...
  nearbySortLabel: { color: "#18B889", fontSize: 10, fontWeight: "900" },
  ...
  nearbyKitchenLinkText: { color: "#18B889", fontSize: 10, fontWeight: "900" },
  ...
  customerOrderBody: { color: "#18B889", fontSize: 10, marginTop: 3 },
  ...
  heroLeafOne: { width: 32, height: 15, borderRadius: 20, backgroundColor: "#00CFE3", position: "absolute", right: -1, top: 35, transform: [{ rotate: "34deg" }] },
  heroLeafTwo: { width: 28, height: 13, borderRadius: 20, backgroundColor: "#18B889", position: "absolute", left: 7, bottom: 31, transform: [{ rotate: "-40deg" }] },
  ...
  chipSelected: { backgroundColor: "#18B889", borderColor: "#18B889" },
  ...
  liveDot: { width: 7, height: 7, borderRadius: 4, backgroundColor: "#18B889" },
  activeOrderEyebrow: { fontSize: 10, color: "#18B889", fontWeight: "900", flex: 1 },
  ...
  openDot: { width: 6, height: 6, borderRadius: 3, backgroundColor: "#18B889" },
  closedDot: { backgroundColor: "#8ABAC0" },
  openText: { fontSize: 10, color: "#18B889", fontWeight: "900" },
  ...
  quantityBadge: { minWidth: 22, height: 22, paddingHorizontal: 6, borderRadius: 11, backgroundColor: "#18B889", alignItems: "center", justifyContent: "center" },
  ...
  storyCard: { flexDirection: "row", gap: 10, padding: 14, borderRadius: 18, backgroundColor: "#E5FCFF", borderWidth: 1, borderColor: "#D9F99D" },
  ...
  complaintHeroBody: { color: "#18B889", fontSize: 11, lineHeight: 17, marginTop: 3 },
  ...
  complaintCardCategory: { color: "#18B889", fontSize: 9, fontWeight: "900" },
  ...
  supportEmptyText: { color: "#18B889", fontSize: 10, fontWeight: "800" },
  ...
  deliveryBody: { fontSize: 11, color: "#18B889", marginTop: 2 },
  ...
  activeOrderChip: { minWidth: 118, maxWidth: 155, backgroundColor: "#F4FCFD", borderRadius: 13, paddingHorizontal: 10, paddingVertical: 8, borderWidth: 1, borderColor: "#D8F1F3", gap: 3 },
  ...
  statusPillText: { color: "#18B889", fontSize: 10, fontWeight: "900" },
  ...
  dashboardHero: { backgroundColor: "#18B889", borderRadius: 23, padding: 18, flexDirection: "row", alignItems: "center", justifyContent: "space-between" },
  ...
  driverOrderChip: { minWidth: 118, maxWidth: 155, backgroundColor: "#F4FCFD", borderRadius: 13, paddingHorizontal: 10, paddingVertical: 8, borderWidth: 1, borderColor: "#D8F1F3", gap: 3 },
  ...
  incomingQueueChip: { minWidth: 118, maxWidth: 155, backgroundColor: "#F4FCFD", borderRadius: 13, paddingHorizontal: 10, paddingVertical: 8, borderWidth: 1, borderColor: "#D8F1F3", gap: 3 },
  ...
  prepNoticeText: { color: "#18B889", fontSize: 11, fontWeight: "800" },
  ...
  menuStatusText: { fontSize: 9, color: "#18B889", fontWeight: "900" },
  cliqCard: { backgroundColor: "#EEF9DB", borderRadius: 18, padding: 13, flexDirection: "row", alignItems: "center", gap: 10 },
  cliqBadge: { width: 42, height: 42, borderRadius: 14, backgroundColor: "#18B889", justifyContent: "center", alignItems: "center" },
  cliqBadgeText: { color: "#FFFFFF", fontSize: 12, fontWeight: "900" },
  cliqCopy: { flex: 1 },
  cliqTitle: { color: "#082E34", fontSize: 12, fontWeight: "900" },
  cliqBody: { color: "#18B889", fontSize: 10, marginTop: 3 },
  profileDashboardCard: { flexDirection: "row", alignItems: "center", gap: 10, backgroundColor: "#18B889", borderRadius: 19, padding: 13 },
  ...
  customerDriverCard: { backgroundColor: "#E5FCFF", borderRadius: 22, padding: 15, gap: 14, borderWidth: 1, borderColor: "#D9F99D" },
  ...
  callDriverButton: { width: 36, height: 36, borderRadius: 18, backgroundColor: "#18B889", alignItems: "center", justifyContent: "center" },
