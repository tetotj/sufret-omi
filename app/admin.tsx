...
const styles = StyleSheet.create({
  loginWrap: { flexGrow: 1, justifyContent: "center", padding: 22, gap: 18, backgroundColor: "#FFF8F0" },
  loginBrand: { alignItems: "center", gap: 7 },
  loginLogo: { width: 70, height: 70, borderRadius: 23, backgroundColor: "#D76545", alignItems: "center", justifyContent: "center", marginBottom: 6 },
  loginEyebrow: { color: "#2E9B72", fontSize: 10, letterSpacing: 1.6, fontWeight: "900" },
  loginTitle: { color: "#38231C", fontSize: 27, fontWeight: "900", textAlign: "center" },
  loginSubtitle: { color: "#7E665A", fontSize: 12, lineHeight: 18, textAlign: "center", maxWidth: 430 },
  loginCard: { width: "100%", maxWidth: 470, alignSelf: "center", backgroundColor: "#FFFFFF", borderRadius: 25, borderWidth: 1, borderColor: "#F1D8C8", padding: 20, gap: 12 },
  lockRow: { flexDirection: "row", alignItems: "center", gap: 7, paddingBottom: 5 },
  lockText: { color: "#D76545", fontSize: 11, fontWeight: "900" },
  formLabel: { color: "#1A4B52", fontSize: 11, fontWeight: "900" },
  inputWrap: { minHeight: 48, borderRadius: 14, borderWidth: 1, borderColor: "#F1D8C8", backgroundColor: "#F1FEFF", flexDirection: "row", alignItems: "center", gap: 8, paddingHorizontal: 12 },
  input: { flex: 1, minWidth: 0, color: "#38231C", fontSize: 13, paddingVertical: 8 },
  errorText: { color: "#C4555D", fontSize: 11, fontWeight: "800" },
  primaryButton: { minHeight: 48, borderRadius: 15, backgroundColor: "#D76545", flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8 },
  ...
  oauthButtonText: { color: "#D76545", fontSize: 10, fontWeight: "900" },
  backToAppText: { color: "#D76545", fontSize: 11, fontWeight: "900" },
  adminFrame: { flex: 1, backgroundColor: "#FFF8F0" },
  adminTopBar: { minHeight: 70, paddingHorizontal: 20, backgroundColor: "#38231C", flexDirection: "row", alignItems: "center", gap: 14 },
  mobileMenu: { width: 36, height: 36, borderRadius: 11, backgroundColor: "#D76545", alignItems: "center", justifyContent: "center" },
  topBrand: { flexDirection: "row", alignItems: "center", gap: 9 },
  topBrandMark: { width: 34, height: 34, borderRadius: 11, backgroundColor: "#D76545", alignItems: "center", justifyContent: "center" },
  topBrandName: { color: "#FFFFFF", fontSize: 13, fontWeight: "900" },
  topBrandSub: { color: "#CDB4A5", fontSize: 9, marginTop: 2 },
  ...
  sidebar: { width: 238, backgroundColor: "#FFFFFF", borderRightWidth: 1, borderRightColor: "#F1D8C8", padding: 14 },
  sidebarMobile: { position: "absolute", zIndex: 10, top: 0, bottom: 0, left: 0, elevation: 8, shadowColor: "#38231C", shadowOpacity: 0.15, shadowRadius: 12 },
  sidebarHeader: { padding: 10, marginBottom: 12 },
  sidebarEyebrow: { color: "#2E9B72", fontSize: 9, letterSpacing: 1.2, fontWeight: "900" },
  sidebarTitle: { color: "#38231C", fontSize: 18, fontWeight: "900", marginTop: 4 },
  sidebarItem: { minHeight: 45, paddingHorizontal: 11, borderRadius: 13, flexDirection: "row", alignItems: "center", gap: 10, marginBottom: 4 },
  sidebarItemActive: { backgroundColor: "#D76545" },
  sidebarItemCopy: { flex: 1, flexDirection: "row", alignItems: "center", justifyContent: "space-between" },
  sidebarItemText: { color: "#7E665A", fontSize: 11, fontWeight: "800" },
  ...
  sidebarCountText: { color: "#38231C", fontSize: 9, fontWeight: "900" },
  ...
  adminName: { color: "#38231C", fontSize: 10, fontWeight: "900" },
  adminRole: { color: "#7CA8AD", fontSize: 9, marginTop: 2 },
  sidebarVersion: { color: "#CDB4A5", fontSize: 8 },
  ...
  pageTitle: { color: "#38231C", fontSize: 26, fontWeight: "900", marginTop: 4 },
  pageSubtitle: { color: "#7E665A", fontSize: 11, lineHeight: 17, marginTop: 5, maxWidth: 700 },
  dateBadge: { paddingHorizontal: 11, paddingVertical: 9, borderRadius: 12, backgroundColor: "#FFFFFF", borderWidth: 1, borderColor: "#F1D8C8", flexDirection: "row", alignItems: "center", gap: 6 },
  dateBadgeText: { color: "#D76545", fontSize: 9, fontWeight: "900" },
  metricGrid: { flexDirection: "row", flexWrap: "wrap", gap: 12 },
  metricCard: { flexGrow: 1, flexBasis: 180, minHeight: 140, padding: 15, borderRadius: 18, backgroundColor: "#FFFFFF", borderWidth: 1, borderColor: "#F1D8C8" },
  ...
  metricLabel: { color: "#7E665A", fontSize: 10, fontWeight: "800" },
  metricValue: { color: "#38231C", fontSize: 28, fontWeight: "900", marginTop: 3 },
  metricDetail: { color: "#7CA8AD", fontSize: 9, marginTop: 1 },
  twoColumn: { flexDirection: "row", flexWrap: "wrap", gap: 16 },
  panel: { flex: 1, minWidth: 300, padding: 16, borderRadius: 19, backgroundColor: "#FFFFFF", borderWidth: 1, borderColor: "#F1D8C8", gap: 10 },
  panelHeader: { flexDirection: "row", alignItems: "flex-start", justifyContent: "space-between", gap: 12 },
  panelTitle: { color: "#38231C", fontSize: 14, fontWeight: "900" },
  panelSubtitle: { color: "#7CA8AD", fontSize: 9, marginTop: 3 },
  panelLink: { color: "#D76545", fontSize: 10, fontWeight: "900" },
  ...
  approvalPreviewTitle: { color: "#38231C", fontSize: 11, fontWeight: "900" },
  approvalPreviewMeta: { color: "#7E665A", fontSize: 9, marginTop: 2 },
  ...
  miniComplaintTitle: { color: "#38231C", fontSize: 10, fontWeight: "900" },
  ...
  emptyPanelText: { color: "#7E665A", fontSize: 10, textAlign: "center" },
  activityPanel: { padding: 16, borderRadius: 19, backgroundColor: "#38231C", gap: 14 },
  ...
  pageCount: { minWidth: 70, padding: 11, borderRadius: 13, backgroundColor: "#FFFFFF", borderWidth: 1, borderColor: "#F1D8C8", alignItems: "center" },
  pageCountValue: { color: "#D76545", fontSize: 22, fontWeight: "900" },
  pageCountLabel: { color: "#7CA8AD", fontSize: 9, marginTop: 1 },
  filterBar: { gap: 12, padding: 14, backgroundColor: "#FFFFFF", borderRadius: 17, borderWidth: 1, borderColor: "#F1D8C8" },
  adminSearch: { height: 43, borderRadius: 13, borderWidth: 1, borderColor: "#F1D8C8", backgroundColor: "#F1FEFF", flexDirection: "row", alignItems: "center", gap: 7, paddingHorizontal: 11 },
  adminSearchInput: { flex: 1, minWidth: 0, color: "#38231C", fontSize: 11, paddingVertical: 0 },
  filterChips: { flexDirection: "row", flexWrap: "wrap", gap: 7 },
  filterChip: { paddingHorizontal: 10, paddingVertical: 7, borderRadius: 10, backgroundColor: "#F1FEFF", borderWidth: 1, borderColor: "#F1D8C8" },
  filterChipActive: { backgroundColor: "#D76545", borderColor: "#D76545" },
  filterChipText: { color: "#7E665A", fontSize: 9, fontWeight: "800" },
  filterChipTextActive: { color: "#FFFFFF" },
  userList: { gap: 9 },
  userCard: { padding: 13, borderRadius: 16, backgroundColor: "#FFFFFF", borderWidth: 1, borderColor: "#F1D8C8", flexDirection: "row", alignItems: "center", gap: 10 },
  userAvatar: { width: 39, height: 39, borderRadius: 14, backgroundColor: "#A8F1F6", alignItems: "center", justifyContent: "center" },
  userAvatarText: { color: "#D76545", fontSize: 16, fontWeight: "900" },
  userMain: { flex: 1, minWidth: 0, gap: 3 },
  userTitleRow: { flexDirection: "row", alignItems: "center", gap: 7 },
  userName: { color: "#38231C", fontSize: 12, fontWeight: "900" },
  statusBadge: { paddingHorizontal: 7, paddingVertical: 4, borderRadius: 8 },
  statusBadgeText: { color: "#7E665A", fontSize: 8, fontWeight: "900" },
  ...
  userDetail: { color: "#7E665A", fontSize: 9 },
  ...
  detailItemValue: { color: "#38231C", fontSize: 10, fontWeight: "900", marginTop: 4 },
  detailBox: { padding: 11, borderRadius: 13, backgroundColor: "#ECFCFD", gap: 4 },
  detailBoxTitle: { color: "#D76545", fontSize: 10, fontWeight: "900" },
  ...
  docLabel: { color: "#7E665A", fontSize: 8, lineHeight: 12 },
  ...
  approveButton: { minHeight: 40, flex: 1, minWidth: 150, paddingHorizontal: 13, borderRadius: 12, backgroundColor: "#D76545", flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 5 },
  ...
  approvalList: { gap: 13 },
  approvalCard: { padding: 16, borderRadius: 19, backgroundColor: "#FFFFFF", borderWidth: 1, borderColor: "#F1D8C8", gap: 13 },
  ...
  newFlagText: { color: "#D76545", fontSize: 8, fontWeight: "900" },
  approvalInfo: { flexDirection: "row", flexWrap: "wrap", gap: 8 },
  emptyComplaints: { minHeight: 230, borderRadius: 20, backgroundColor: "#FFFFFF", borderWidth: 1, borderColor: "#F1D8C8", alignItems: "center", justifyContent: "center", padding: 24, gap: 8 },
  emptyTitle: { color: "#38231C", fontSize: 14, fontWeight: "900", textAlign: "center" },
  emptyBody: { color: "#7E665A", fontSize: 10, lineHeight: 16, textAlign: "center", maxWidth: 360 },
  complaintsAdminList: { gap: 12 },
  adminComplaintCard: { padding: 16, borderRadius: 19, backgroundColor: "#FFFFFF", borderWidth: 1, borderColor: "#F1D8C8", gap: 10 },
  ...
  adminComplaintTitle: { color: "#38231C", fontSize: 13, fontWeight: "900" },
  ...
  responseText: { flex: 1, color: "#D76545", fontSize: 10, lineHeight: 15, fontWeight: "800" },
  adminComplaintActions: { gap: 8, paddingTop: 4, borderTopWidth: 1, borderTopColor: "#E7F9FA" },
  complaintResponseInput: { minHeight: 43, maxHeight: 80, borderRadius: 11, borderWidth: 1, borderColor: "#F1D8C8", backgroundColor: "#F1FEFF", color: "#38231C", fontSize: 10, paddingHorizontal: 10, paddingVertical: 8, textAlignVertical: "top" },
  ...
  complaintResolveButton: { flex: 1, minHeight: 37, borderRadius: 11, backgroundColor: "#D76545", flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 5 },
  complaintResolveText: { color: "#FFFFFF", fontSize: 9, fontWeight: "900" },
  settingsPanel: { backgroundColor: "#FFFFFF", borderRadius: 19, borderWidth: 1, borderColor: "#F1D8C8", overflow: "hidden" },
  ...
  settingStatusTitle: { color: "#38231C", fontSize: 12, fontWeight: "900" },
  settingStatusBody: { color: "#7E665A", fontSize: 10, lineHeight: 16 },
  ...
  securityNoteTitle: { color: "#D76545", fontSize: 12, fontWeight: "900" },
