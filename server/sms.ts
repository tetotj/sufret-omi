...
export async function sendOtpSms(input: OtpInput) {
  ...
  const body = input.language === "ar"
    ? `سفرة أمي: رمز التحقق الخاص بك هو ${input.code}. صالح لمدة 5 دقائق.`
    : `Sufret Omi: Your verification code is ${input.code}. It expires in 5 minutes.`;
